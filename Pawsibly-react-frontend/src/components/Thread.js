...
useEffect(() => {
  ...
  const messageContent = {sender_user:4, receiver_user:user.id, msg_content:writeMessages};
  const sendMessage = () => {
  ...
  return (
    ...
    <input type='text'  value={writeMessages} onChange={(e)=> setWriteMessages(e.target.value)} />
