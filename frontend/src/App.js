        ...
        <SitterProvider>
          ...
          <Container>
            <Routes>
              ...
              />
              <Route
                path="/sitterlisting/:id"
                element={<SitterDetail user={user} />}
              />
              <Route
                path="/contact/:id"
                element={<ContactScreen user={user} />}
              />
